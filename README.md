...
To understand how to use this package, please refer to the [Getting Started](https://insightsengineering.github.io/teal.reporter/main/articles/getting-started-with-teal-reporter.html) article, which provides multiple examples of code implementation.
